...
c1.filter_entities(entity_selection_list=[0,1,2,3,4,5], entity_selection_lambda=lambda x: x > 100, additional_selection=(Chunk.Filter.ALL), remove_duplicates=False)
draw.test_gen_fig_scatter(c1).show()
