...
'''
# draw histogram
#draw.gen_fig_scatter(db.get_timing_data("test3").create_chunk(), show_mean=True).show()
#draw.gen_fig_histo_rel_to_mean(db.get_timing_data('test1').create_chunk(), show_start_not_end=False).show()
draw.gen_fig_histo_rel_to_mean(db.create_chunks(), show_start_not_end=False).show()
draw.gen_fig_histo_rel_to_mean(db.create_chunks(), show_start_not_end=False, show_run_not_operation=False).show()